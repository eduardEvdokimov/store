...
<section class="content">
    <div class="row">
        <div class="col-md-12">
            <div class="box">
                <form action="<?=HOST_ADMIN;?>/currency/add" method="post" data-toggle="validator">
                    <div class="box-body">
                        <div class="form-group has-feedback">
                            <label for="code">Код валюты</label>
                            <input type="text" name="code" class="form-control" id="code" placeholder="USD, EUR" required>
                            <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                        </div>
                        <div class="form-group">
                            <label for="symbol_left">Тег символа валюты</label>
                            <input type="text" name="symbol" class="form-control" id="symbol_left" placeholder="<i class='symbol'></i>">
                        </div>
                        <div class="form-group has-feedback">
