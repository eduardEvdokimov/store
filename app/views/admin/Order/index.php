                        ...
                        <table class="table table-bordered table-hover">
                            ...
                            <?php foreach($orders as $order): ?>
                                ...
                                <tr class="<?=$class;?>">
                                    ...
                                    <td><a href="<?=HOST_ADMIN;?>/order/view?id=<?=$order['id'];?>"><i class="fa fa-fw fa-eye"></i></a> <a class="delete" href="<?=HOST_ADMIN;?>/order/delete?id=<?=$order['id'];?>"><i class="fa fa-fw fa-close text-danger"></i></a></td>
                                </tr>
                            <?php endforeach; ?>
                            </tbody>
                        </table>
