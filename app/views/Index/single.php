				...
				<div class="single-page-row" id="detail-21">
					<div class="col-md-6 single-top-left">	
						<div class="flexslider">
							<ul class="slides">
								<li data-thumb="<?= HOST ?>/images/s1.jpg">
									<div class="thumb-image detail_images"> <img src="<?= HOST ?>/images/s1.jpg" data-imagezoom="true" class="img-responsive" alt=""> </div>
								</li>
								<li data-thumb="<?= HOST ?>/images/s2.jpg">
