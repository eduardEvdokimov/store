        ...
        <div class="w3ls-header"><!--header-one--> 
            ...
            <div class="w3ls-header-right">
                <ul>
                    ...
                    <li class="dropdown head-dpdn">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-percent" aria-hidden="true"></i>Валюта<span class="caret"></span></a>
                        <ul class="dropdown-menu">
                            <li><a href="offers.html">USD <i class="fa fa-usd" aria-hidden="true"></i></a></li> 
                            <li><a href="offers.html">EUR <i class="fa fa-eur" aria-hidden="true"></i></a></li>
                            <li><a href="offers.html">UAH <i class="fas fa-hryvnia"></i></a></li>
                            <li><a href="offers.html">RUB <i class="fa fa-rub" aria-hidden="true"></i></a></li> 
                        </ul> 
                    </li> 
                    <li class="dropdown head-dpdn">
